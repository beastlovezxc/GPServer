	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			...
			<script src= "javascript/moment-2.2.1.js" type="text/javascript"></script>
			<script src="javascript/clndr.js" type="text/javascript"></script>
...
<script src="javascript/jquery.vmap.js"></script>
<script src="javascript/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="javascript/jquery.vmap.world.js" type="text/javascript"></script>
